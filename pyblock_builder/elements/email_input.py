...
from pyblock_builder.objects import DispatchActionConfig
...
class EmailInput:
    ...
    def set_placeholder_text(self, placeholder_text: PlainText) -> Self:
        """
        (Optional) Sets the placeholder text shown on the email input
    ...
    def set_initial_value(self, initial_value: str) -> Self:
        """
        (Optional) Sets the initial value to be shown in the email input
        :param initial_value: String
        :return: self
        """
        if not isinstance(initial_value, str):
            raise IncorrectTypeError(self, method="set_initial_value", compatible_types=str, incompatible_type=initial_value)
